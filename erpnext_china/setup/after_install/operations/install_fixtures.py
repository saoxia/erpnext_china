...
def install(country='China'):
	...
	#改进的翻译
	tanslation_filepath = Path(__file__).parent.parent.parent.parent / 'translation' / 'zh.csv'
	with open(tanslation_filepath, 'r',encoding='utf8') as f:
		data = f.read()

	with open((Path(__file__).parent.parent.parent.parent.parent.parent / 'erpnext' / 'erpnext' / 'translation' / 'zh.csv'), 'a',encoding='utf8') as file:
		# 写入要追加的文本
		file.write('\n')
		file.write(data)
